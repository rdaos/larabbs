    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                <li class="{{ active_class(if_route('topics.index')) }}"><a href="{{ route('topics.index') }}">社区</a>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li class="{{ active_class((if_route('categories.show') && if_route_param('category', 1))) }}">
                            <a href="{{ route('categories.show', 1) }}"><i class="glyphicon glyphicon-send"></i>分享</a>
                        </li>
                        <li class="{{ active_class((if_route('categories.show') && if_route_param('category', 2))) }}">
                            <a href="{{ route('categories.show', 2) }}"><i class="glyphicon glyphicon-education"></i>教程</a>
                        </li>
                        <li class="{{ active_class((if_route('categories.show') && if_route_param('category', 3))) }}">
                            <a href="{{ route('categories.show', 3) }}"><i class="glyphicon glyphicon-question-sign"></i>问答</a>
                        </li>
                        <li class="{{ active_class((if_route('categories.show') && if_route_param('category', 4))) }}">
                            <a href="{{ route('categories.show', 4) }}"><i class="glyphicon glyphicon-bell"></i>公告</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <form method="GET" action="{{ route('search') }}" accept-charset="UTF-8"
                    ...
                    <div class="form-group search-group">
                        <input placeholder="搜索" name="q" type="text" value=""

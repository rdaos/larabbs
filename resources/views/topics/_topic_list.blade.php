            ...
            <li class="media">
                ...
                <div class="media-body">
                    ...
                    <div class="media-body meta">
                        ...
                        <a href="{{ route('categories.show', $topic->category->id) }}" title="{{ $topic->category->name }}" class="mr5">
                            <span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span>
                            {{ $topic->category->name }}
                        </a>

                        <span class="mr5"> • </span>
                        <a href="{{ route('users.show', [$topic->user_id]) }}" title="{{ $topic->user->name }}" class="mr5">
                        ...
                        <span class="timeago" title="浏览量">{{ $topic->view_count }}</span>
